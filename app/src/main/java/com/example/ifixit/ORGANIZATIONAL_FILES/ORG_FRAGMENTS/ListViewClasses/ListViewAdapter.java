package com.example.ifixit.ORGANIZATIONAL_FILES.ORG_FRAGMENTS.ListViewClasses;
...
import com.example.ifixit.ORGANIZATIONAL_FILES.OrgCheckOutActivity;
    ...
    public void onBindViewHolder(@NonNull ListViewHolder holder, int position) {
        ...
        holder.hireButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, OrgCheckOutActivity.class);
